...
async function fetchProducts() {
    ...
    const res = await api.get("products", { per_page: 45, status: "publish", stock_status: "instock", fields: fieldsToFetch.join(','), category: 1046 })
...
<h2 className="fse-4 fw-4 text-center">Deals</h2>
